...
class MediaService : Service(), MediaPlayerCallback {
    ...
    companion object{
        const val ACTION_CREATE = "com.example.mediaplayerwithservicenotif.mediaservice.create"
        const val ACTION_DESTROY = "com.example.mediaplayerwithservicenotif.mediaservice.destroy"
        const val TAG = "MediaService"
        const val PLAY = 0
        const val STOP = 1
        const val CHANNEL_DEFAULT_IMPORTANCE = "Channer_Test"
